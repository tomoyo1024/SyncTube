// Generated by Haxe 5.0.0-preview.1+05f01a18b
...
server_HttpServer.prototype = {
	...
	,uploadFile: function(req,res) {
		...
		stream.on("error",function(err) {
			haxe_Log.trace(err,{ fileName : "src/server/HttpServer.hx", lineNumber : 230, className : "server.HttpServer", methodName : "uploadFile"});
		...
		req.on("error",function(err) {
			haxe_Log.trace("Request Error:",{ fileName : "src/server/HttpServer.hx", lineNumber : 237, className : "server.HttpServer", methodName : "uploadFile", customParams : [err]});
			stream.destroy();
	...
	,finishSetup: function(req,res) {
		...
		req.on("end",function() {
			...
			if(jsonParser.errors.length > 0) {
				haxe_Log.trace(json2object_ErrorUtils.convertErrorArray(jsonParser.errors),{ fileName : "src/server/HttpServer.hx", lineNumber : 263, className : "server.HttpServer", methodName : "finishSetup"});
	...
	preparePort = function() {
		server_Utils.isPortFree(_gthis.port,function(isFree) {
			if(!isFree && attempts > 0) {
				haxe_Log.trace("Warning: port " + _gthis.port + " is already in use. Changed to " + (_gthis.port + 1),{ fileName : "src/server/Main.hx", lineNumber : 161, className : "server.Main", methodName : "new"});
				attempts -= 1;
				_gthis.port++;
				preparePort();
				return;
...
server_Main.prototype = {
	...
	,runServer: function() {
		...
		haxe_Log.trace("Local: " + protocol + "://" + this.localIp + colonPort,{ fileName : "src/server/Main.hx", lineNumber : 191, className : "server.Main", methodName : "runServer"});
		if(this.config.localNetworkOnly) {
			haxe_Log.trace("Global network is disabled in config",{ fileName : "src/server/Main.hx", lineNumber : 193, className : "server.Main", methodName : "runServer"});
			...
			server_Utils.getGlobalIp(function(ip) {
				...
				_gthis.globalIp = ip;
				haxe_Log.trace("Global: " + protocol + "://" + _gthis.globalIp + colonPort,{ fileName : "src/server/Main.hx", lineNumber : 199, className : "server.Main", methodName : "runServer"});
			});
		}
		...
		if(ssl == null) {
			...
			if(this.isDefaultPort()) {
				try {
					...
					haxe_Log.trace("Cannot run http server on port 80 for https redirects:",{ fileName : "src/server/Main.hx", lineNumber : 225, className : "server.Main", methodName : "runServer", customParams : [_g1]});
				}
			}
	...
	,getSslConfig: function(config) {
		...
		if(!sys_FileSystem.exists(config.sslKeyPemPath)) {
			haxe_Log.trace("sslKeyPemPath: absolute file path not found: " + config.sslKeyPemPath,{ fileName : "src/server/Main.hx", lineNumber : 263, className : "server.Main", methodName : "getSslConfig"});
		}
		if(!sys_FileSystem.exists(config.sslCertPemPath)) {
			haxe_Log.trace("sslCertPemPath: absolute file path not found: " + config.sslCertPemPath,{ fileName : "src/server/Main.hx", lineNumber : 265, className : "server.Main", methodName : "getSslConfig"});
		}
		return null;
	}
	...
	,getUserConfig: function() {
		...
		while(_g < _g1.length) {
			...
			if(Reflect.field(config,field) == null) {
				haxe_Log.trace("Warning: config field \"" + field + "\" is unknown",{ fileName : "src/server/Main.hx", lineNumber : 311, className : "server.Main", methodName : "getUserConfig"});
			}
		...
		while(_g < _g1.length) {
			...
			if(emoteCopies_h[emote.name]) {
				haxe_Log.trace("Warning: emote name \"" + emote.name + "\" has copy",{ fileName : "src/server/Main.hx", lineNumber : 319, className : "server.Main", methodName : "getUserConfig"});
			}
			...
			if(emoteCopies_h[emote.image]) {
				haxe_Log.trace("Warning: emote url of name \"" + emote.name + "\" has copy",{ fileName : "src/server/Main.hx", lineNumber : 323, className : "server.Main", methodName : "getUserConfig"});
			}
	...
	,saveState: function() {
		haxe_Log.trace("Saving state...",{ fileName : "src/server/Main.hx", lineNumber : 361, className : "server.Main", methodName : "saveState"});
	...
	,loadState: function() {
		...
		haxe_Log.trace("Loading state...",{ fileName : "src/server/Main.hx", lineNumber : 385, className : "server.Main", methodName : "loadState"});
	...
	,logError: function(type,data) {
		...
		haxe_Log.trace(type,{ fileName : "src/server/Main.hx", lineNumber : 409, className : "server.Main", methodName : "logError", customParams : [data]});
	...
	,initIntergationHandlers: function() {
		...
		new haxe_Timer(600000).run = function() {
			...
			haxe_Log.trace("Ping " + url,{ fileName : "src/server/Main.hx", lineNumber : 422, className : "server.Main", methodName : "initIntergationHandlers"});
	...
	,addAdmin: function(name,password) {
		...
		haxe_Log.trace("Admin " + name + " added.",{ fileName : "src/server/Main.hx", lineNumber : 443, className : "server.Main", methodName : "addAdmin"});
	}
	,removeAdmin: function(name) {
		HxOverrides.remove(this.userList.admins,Lambda.find(this.userList.admins,function(item) {
			return item.name == name;
		}));
		haxe_Log.trace("Admin " + name + " removed.",{ fileName : "src/server/Main.hx", lineNumber : 450, className : "server.Main", methodName : "removeAdmin"});
	}
	,hasAdmins: function() {
	...
	,onConnect: function(ws,req) {
		...
		var name = "Guest " + (id + 1);
		haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 513, className : "server.Main", methodName : "onConnect", customParams : ["" + name + " connected (" + ip + ")"]});
		...
		ws.on("message",function(data) {
			...
			if(_gthis.wsEventParser.errors.length > 0 || _gthis.noTypeObj(obj)) {
				...
				haxe_Log.trace(errors,{ fileName : "src/server/Main.hx", lineNumber : 530, className : "server.Main", methodName : "onConnect"});
	...
	,onMessage: function(client,data,internal) {
		...
		case "CrashTest":
			...
			haxe_Log.trace("Crashing...",{ fileName : "src/server/Main.hx", lineNumber : 1084, className : "server.Main", methodName : "onMessage"});
			null[1]++;
			break;
		case "Disconnected":
			if(!internal) {
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 595, className : "server.Main", methodName : "onMessage", customParams : ["Client " + client.name + " disconnected"]});
		...
		case "Login":
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 686, className : "server.Main", methodName : "onMessage", customParams : ["Client " + client.name + " logged as " + name]});
			client.name = name;
		...
		case "Logout":
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 707, className : "server.Main", methodName : "onMessage", customParams : ["Client " + oldName + " logout to " + client.name]});
	...
	,checkBan: function(client) {
		...
		while(_g_i > -1) {
			...
			if(isOutdated) {
				...
				haxe_Log.trace("" + client.name + " ban removed",{ fileName : "src/server/Main.hx", lineNumber : 1274, className : "server.Main", methodName : "checkBan"});
				this.sendClientList();
			}
			break;
		}
