// Generated by Haxe 5.0.0-preview.1+97696c054
...
server_Main.prototype = {
		...
		if(ssl == null) {
			...
			if(this.isDefaultPort()) {
				try {
					...
					haxe_Log.trace("Cannot run http server on port 80 for https redirects:",{ fileName : "src/server/Main.hx", lineNumber : 226, className : "server.Main", methodName : "runServer", customParams : [_g1]});
				}
			}
	...
	,getSslConfig: function(config) {
		...
		if(!sys_FileSystem.exists(config.sslKeyPemPath)) {
			haxe_Log.trace("sslKeyPemPath: absolute file path not found: " + config.sslKeyPemPath,{ fileName : "src/server/Main.hx", lineNumber : 264, className : "server.Main", methodName : "getSslConfig"});
		}
		if(!sys_FileSystem.exists(config.sslCertPemPath)) {
			haxe_Log.trace("sslCertPemPath: absolute file path not found: " + config.sslCertPemPath,{ fileName : "src/server/Main.hx", lineNumber : 266, className : "server.Main", methodName : "getSslConfig"});
		}
		return null;
	}
	...
	,getUserConfig: function() {
		...
		while(_g < _g1.length) {
			...
			if(Reflect.field(config,field) == null) {
				haxe_Log.trace("Warning: config field \"" + field + "\" is unknown",{ fileName : "src/server/Main.hx", lineNumber : 312, className : "server.Main", methodName : "getUserConfig"});
			}
		...
		while(_g < _g1.length) {
			...
			if(emoteCopies_h[emote.name]) {
				haxe_Log.trace("Warning: emote name \"" + emote.name + "\" has copy",{ fileName : "src/server/Main.hx", lineNumber : 320, className : "server.Main", methodName : "getUserConfig"});
			}
			...
			if(emoteCopies_h[emote.image]) {
				haxe_Log.trace("Warning: emote url of name \"" + emote.name + "\" has copy",{ fileName : "src/server/Main.hx", lineNumber : 324, className : "server.Main", methodName : "getUserConfig"});
			}
	...
	,saveState: function() {
		haxe_Log.trace("Saving state...",{ fileName : "src/server/Main.hx", lineNumber : 362, className : "server.Main", methodName : "saveState"});
	...
	,loadState: function() {
		...
		haxe_Log.trace("Loading state...",{ fileName : "src/server/Main.hx", lineNumber : 386, className : "server.Main", methodName : "loadState"});
	...
	,logError: function(type,data) {
		...
		haxe_Log.trace(type,{ fileName : "src/server/Main.hx", lineNumber : 410, className : "server.Main", methodName : "logError", customParams : [data]});
	...
	,initIntergationHandlers: function() {
		...
		new haxe_Timer(600000).run = function() {
			...
			haxe_Log.trace("Ping " + url,{ fileName : "src/server/Main.hx", lineNumber : 423, className : "server.Main", methodName : "initIntergationHandlers"});
	...
	,addAdmin: function(name,password) {
		...
		haxe_Log.trace("Admin " + name + " added.",{ fileName : "src/server/Main.hx", lineNumber : 444, className : "server.Main", methodName : "addAdmin"});
	}
	,removeAdmin: function(name) {
		HxOverrides.remove(this.userList.admins,Lambda.find(this.userList.admins,function(item) {
			return item.name == name;
		}));
		haxe_Log.trace("Admin " + name + " removed.",{ fileName : "src/server/Main.hx", lineNumber : 451, className : "server.Main", methodName : "removeAdmin"});
	}
	,hasAdmins: function() {
	...
	,onConnect: function(ws,req) {
		...
		var name = "Guest " + (id + 1);
		haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 514, className : "server.Main", methodName : "onConnect", customParams : ["" + name + " connected (" + ip + ")"]});
		...
		ws.on("message",function(data) {
			...
			if(_gthis.wsEventParser.errors.length > 0 || _gthis.noTypeObj(obj)) {
				...
				haxe_Log.trace(errors,{ fileName : "src/server/Main.hx", lineNumber : 531, className : "server.Main", methodName : "onConnect"});
	...
	,onMessage: function(client,data,internal) {
		...
		case "CrashTest":
			...
			haxe_Log.trace("Crashing...",{ fileName : "src/server/Main.hx", lineNumber : 1085, className : "server.Main", methodName : "onMessage"});
			null[1]++;
			break;
		case "Disconnected":
			if(!internal) {
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 596, className : "server.Main", methodName : "onMessage", customParams : ["Client " + client.name + " disconnected"]});
		...
		case "Login":
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 687, className : "server.Main", methodName : "onMessage", customParams : ["Client " + client.name + " logged as " + name]});
			client.name = name;
		...
		case "Logout":
			...
			haxe_Log.trace(HxOverrides.dateStr(new Date()),{ fileName : "src/server/Main.hx", lineNumber : 708, className : "server.Main", methodName : "onMessage", customParams : ["Client " + oldName + " logout to " + client.name]});
	...
	,checkBan: function(client) {
		...
		while(_g_i > -1) {
			...
			if(isOutdated) {
				...
				haxe_Log.trace("" + client.name + " ban removed",{ fileName : "src/server/Main.hx", lineNumber : 1275, className : "server.Main", methodName : "checkBan"});
				this.sendClientList();
			}
			break;
		}
