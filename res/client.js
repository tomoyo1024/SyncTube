...
client_Main.prototype = {
	...
	,addVideo: function(url,atEnd,isTemp,doCache,afterSend) {
		...
		if(isServerResolvesMeta && this.getLinkPlayerType(url) == "VkType") {
			sendItem({ duration : 0, title : "", url : url, playerType : "VkType"});
			return;
		}
	...
	,onMessage: function(e) {
		...
		if(this.config != null && this.config.isVerbose) {
			var t = data.type;
			haxe_Log.trace("Event: " + data.type,{ fileName : "src/client/Main.hx", lineNumber : 549, className : "client.Main", methodName : "onMessage", customParams : [Reflect.field(data,t.charAt(0).toLowerCase() + HxOverrides.substr(t,1,null))]});
		}
...
client_Player.prototype = {
	...
	,skipAd: function() {
		...
		http.onError = function(msg) {
			haxe_Log.trace(msg,{ fileName : "src/client/Player.hx", lineNumber : 703, className : "client.Player", methodName : "skipAd"});
		};
		http.request();
	}
	,isPaused: function() {
